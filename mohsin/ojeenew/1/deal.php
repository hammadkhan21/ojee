...
<?php
	...
	if($res = mysqli_num_rows($img_run) == 1){
		echo "<img src='$img_row[image_path]'>";
	} else {
			...
			echo "
				<div class='item active'>
					...
					<div class='carousel-caption'>
						<h4>My First Image</h4>
						<p>This is the first carousel Image</p>
					</div>
				</div>
		";
		} else {
...
<li class="tip tooltipstered"><span class="head">Order on Phone</span><span class="details"><i class="fa fa-phone"></i>Call at <strong>03-111-124455</strong><br> to order via Phone</span></li>
</ul>
	...
	<div class="container footer-container box2">
		<div class="row">
			<div class="col-xs-12" id="copyright">
				<p>Copyright 2014-2016 © <a href="https://www.chillyaar.com/">Chill Yaar</a> All Rights Reserved. An <a href="http://www.oddpals.com/">OddPals</a> venture.</p>
			</div>
		</div>
	</div>
</footer>
