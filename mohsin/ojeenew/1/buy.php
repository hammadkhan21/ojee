...
<?php
	if(isset($_POST['order_submit'])){
		...
		$ins_order = "INSERT INTO orders(buyer_name, post_url, order_time, buyer_email, buyer_cell, buyer_address, buyer_city) VALUES ('$_POST[name]', '$_GET[title]', '$converted_time', '$_POST[email]', '$_POST[mobile]', '$_POST[address]', '$_POST[city]')";
	...
	class QRCode		
{		
    const API_URL = "http://sendpk.com/api/sms.php?username=923122080020&password=mohsin2526&sender=mohsin";
    public $_sData;					
