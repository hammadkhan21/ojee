<?php session_start();
	...
	if(isset($_POST['update_category'])){
		...
		$sql = "UPDATE categories SET cat_name = '$category' WHERE cat_id = $_POST[cat_id]";
					...
					<div class="container-fluid">
						<form class="form-horizontal col-lg-5" action="edit_category.php" method="post">
							<div class="form-group">
								...
								<input id="category" type="text" value="<?php echo $rows['cat_name']; ?>"name="category" class="form-control">
							</div>
							<div class="form-group">
